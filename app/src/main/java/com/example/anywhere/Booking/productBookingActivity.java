...
public class productBookingActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    TextView dateText, timeText, priceText, nameText;
    EditText humanText;
    RelativeLayout layout;
    String code, price, epEmail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layout = findViewById(R.id.TopLay);
...
//                .document("timeset").set(data);
    ...
    public void BookBtn(View view) {
        ...
        String userEmail = fbsconnect.fb_userEmail();
        String userName = nameText.getText().toString();
        String humanCount=humanText.getText().toString();
        int i;
